...
export default function MethodeIntro() {
  ...
  return (
    <section
      ref={container}
      className="w-full py-24 md:py-32 px-6 bg-gray-50 border-b border-gray-100"
    >
        ...
        <div className="flex-1 intro-content pt-2">
          <p className="text-xl md:text-2xl text-gray-700 font-light leading-relaxed mb-8">
            ...
            <strong className="text-secondary font-medium">
              structurons, automatisons, formons et pilotons.
            </strong>
          </p>

          <p className="text-gray-500 text-lg leading-relaxed mb-12">
            Votre fiduciaire reste en place. Vos équipes deviennent plus
            efficaces. <br />
          ...
          <div className="flex flex-col sm:flex-row gap-4">
            ...
            <a
              ...
              className="px-8 py-4 bg-transparent border border-gray-300 text-gray-600 rounded-full font-bold uppercase tracking-wider text-xs hover:border-primary hover:text-primary transition-colors duration-300 text-center"
            >
              Réserver un audit
            </a>
          </div>
