      ...
      <div className="max-w-4xl mx-auto text-center">
        <div className="bg-gradient-to-br from-primary to-[#002f20] rounded-[3rem] p-12 md:p-20 shadow-2xl relative overflow-hidden group">
          ...
          <div className="flex flex-col sm:flex-row gap-5 justify-center relative z-10">
            <Link
              href="/contact"
              className="px-8 py-4 bg-white text-primary rounded-full font-bold uppercase tracking-wider text-sm hover:bg-secondary hover:text-white transition-all duration-300 shadow-xl hover:scale-105 text-center"
            >
            ...
            <Link
              ...
              target="_blank"
              className="px-8 py-4 bg-transparent border border-white text-white rounded-full font-bold uppercase tracking-wider text-sm hover:bg-white/10 transition-all duration-300 text-center"
            >
