...
const SERVICES = [
  ...
  },
  {
    ...
    description:
      "Des processus finances fluides et sans tâches manuelles inutiles.",
    image:
  ...
  },
  {
    ...
    description:
      "Tenue comptable, Encodage factures, Clôtures complètes, Mission fiduciaire.",
    image:
...
export default function AboutServices() {
  ...
  return (
    <section
      ref={container}
      className="relative w-full bg-primary text-white py-24 px-6 md:px-12 overflow-hidden"
    >
      <div className="max-w-7xl mx-auto grid grid-cols-1 lg:grid-cols-12 gap-12">
        ...
        <div className="lg:col-span-4 flex flex-col justify-center">
          ...
          <p className="text-white/70 text-base leading-relaxed mb-6">
            Comme un laboratoire produit des résultats, l’expert-comptable
            produit les données. Comme un médecin analyse les résultats, nous
            interprétons, expliquons et guidons vos décisions.
          </p>
          ...
          <p className="text-white/60 text-sm italic mb-10 border-l-2 border-secondary pl-4 py-1">
            Nous ne faisons pas votre comptabilité. Si vous avez besoin d’un
            fiduciaire, nous vous orientons vers notre partenaire{" "}
            <span className="text-white font-semibold">Odoo Finances</span>.
          </p>

          <div className="flex flex-col sm:flex-col gap-4">
            <Link
              href="/contact"
              className="bg-secondary text-primary font-bold px-8 py-4 rounded-sm hover:bg-secondary/90 transition-colors uppercase tracking-wide text-sm text-center"
            >
            ...
            <a
              ...
              className="border border-white/30 text-white font-medium px-6 py-3 rounded-sm hover:bg-white hover:text-primary transition-all uppercase tracking-wide text-xs text-center"
            >
          ...
          <div className="grid grid-cols-3 grid-rows-[200px_200px_200px] gap-4">
            ...
            <div className="service-card group relative overflow-hidden rounded-lg cursor-pointer col-start-1 row-start-1">
              ...
              <div className="absolute inset-0 p-4 flex flex-col justify-end z-10">
                <span className="text-secondary group-hover:text-primary text-xs font-bold">
                  {SERVICES[0].number}
                </span>
                <h4 className="text-white group-hover:text-primary font-medium text-sm mt-1 transition-colors">
                  {SERVICES[0].title}
                </h4>
              </div>
            </div>
            ...
            <div className="service-card group relative overflow-hidden rounded-lg cursor-pointer col-start-2 row-start-1 row-span-2">
              ...
              <div className="absolute inset-0 p-6 flex flex-col justify-end z-10">
                <span className="text-secondary group-hover:text-primary text-sm font-bold">
                  {SERVICES[1].number}
                </span>
                <h4 className="text-white group-hover:text-primary font-semibold text-xl mt-1 transition-colors">
                  {SERVICES[1].title}
                </h4>
                <p className="text-white/70 group-hover:text-primary/70 text-sm mt-2 transition-colors">
            ...
            <div className="service-card group relative overflow-hidden rounded-lg cursor-pointer col-start-1 col-span-2 row-start-3">
              ...
              <div className="absolute inset-0 p-6 flex flex-col justify-end z-10">
                ...
                <h4 className="text-white group-hover:text-primary font-semibold text-lg mt-1 transition-colors">
                  {SERVICES[5].title}
                </h4>
                <p className="text-white/70 group-hover:text-primary/70 text-sm mt-1 transition-colors">
