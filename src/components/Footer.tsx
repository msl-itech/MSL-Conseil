      ...
      <div className="max-w-7xl mx-auto">
        <div className="grid grid-cols-1 md:grid-cols-12 gap-12 md:gap-8 mb-20">
          ...
          <div className="md:col-span-4 space-y-8">
            ...
            <p className="text-gray-400 font-light leading-relaxed pr-6">
              ...
              Nous transformons votre gestion financière en un levier de
              croissance sécurisé et serein.
            </p>
            <div className="flex gap-4">
              ...
              <a
                ...
                className="text-secondary/80 hover:text-white transition-colors text-sm uppercase tracking-wider font-bold border-b border-secondary/30 hover:border-white pb-1"
              >
                LinkedIn
              </a>
              <a
            ...
            <ul className="space-y-4">
              {[
                ...
                <li key={link.label}>
                  <Link
                    href={link.href}
                    className="text-gray-400 hover:text-secondary hover:pl-2 transition-all duration-300 block w-fit"
                  >
                    {link.label}
                  </Link>
                </li>
            ...
            <div className="space-y-6">
              <div>
                ...
                <a
                  ...
                  className="text-xl md:text-2xl font-light hover:text-secondary transition-colors"
                >
              ...
              <div className="flex gap-12">
                <div>
                  ...
                  <p className="text-gray-300">
                    Rue de la Magnanerie 20 1180 UCCLE
                  </p>
                </div>
                <div>
                  <span className="text-xs font-bold uppercase tracking-widest text-gray-500 block mb-2">
                  ...
                  <p className="text-gray-300">
                    Regus Marrakech M Avenue, M Avenue Project, Marrakech, 40000
                  </p>
                </div>
              </div>
            </div>
        ...
        <div className="border-t border-white/10 pt-8 flex flex-col md:flex-row justify-between items-center gap-4 text-xs text-gray-500">
          <p suppressHydrationWarning>
            &copy; {new Date().getFullYear()} MSL Conseils. Tous droits
            réservés.
          </p>
