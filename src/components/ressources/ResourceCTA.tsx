        ...
        <section className="w-full py-32 px-6 bg-primary text-white text-center flex flex-col items-center justify-center relative overflow-hidden">
            ...
            <div className="relative z-10 max-w-2xl">
                ...
                <div className="flex flex-col sm:flex-row gap-6 justify-center">
                    ...
                    <Link href="https://odoo.mslconseils.be/book/911999cf" target="_blank" className="px-8 py-4 border border-white/30 rounded-full font-bold uppercase tracking-wider text-xs hover:bg-white/10 transition-colors hover:scale-105 transform duration-300 text-center">
                        Parler à un expert
                    </Link>
                </div>
            </div>
