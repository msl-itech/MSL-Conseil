      ...
      <div className="relative z-10 max-w-2xl">
        ...
        <div className="flex flex-col sm:flex-row gap-6 justify-center">
          ...
          <Link
            ...
            target="_blank"
            className="px-8 py-4 border border-white/30 rounded-full font-bold uppercase tracking-wider text-xs hover:bg-white/10 transition-colors hover:scale-105 transform duration-300 text-center"
          >
            Parler à un expert
          </Link>
        </div>
