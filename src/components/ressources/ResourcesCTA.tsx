      ...
      <div className="final-res-cta max-w-5xl mx-auto rounded-[3rem] bg-[#0a0a0a] text-white p-12 md:p-20 text-center relative overflow-hidden">
        ...
        <div className="relative z-10">
          ...
          <p className="text-xl text-white/70 mb-12 max-w-2xl mx-auto">
            Téléchargez notre pack complet de ressources ou contactez-nous pour
          ...
          <div className="flex flex-col sm:flex-row gap-6 justify-center">
            ...
            <a
              ...
              className="bg-secondary text-white px-10 py-5 rounded-full font-bold text-lg hover:bg-white hover:text-black transition-all shadow-xl hover:shadow-secondary/20 hover:-translate-y-1 inline-block"
            >
              👉 Parler à un expert
            </a>
          </div>
