...
const LEVELS_INFO: Record<string, { color: string; emoji: string; description: string }> = {
    "Structuration absente": { color: "red", emoji: "🔴", description: "Votre comptabilité est un frein. Il est urgent de structurer les bases." },
    "Structuration en cours": { color: "orange", emoji: "🟠", description: "Bonne base, mais pas encore optimisée. Continuez à structurer." },
    "Comptabilité optimisée": { color: "green", emoji: "🟢", description: "Comptabilité bien structurée ! Prêt pour l'automatisation." },
};

export default function SharedResults({ score, level, fromName, onStartDiagnostic, onReadGuide }: SharedResultsProps) {
    const containerRef = useRef<HTMLElement>(null);
    const levelInfo = LEVELS_INFO[level] || LEVELS_INFO["Structuration en cours"];
            ...
            <div className="relative z-10 max-w-2xl mx-auto text-center">
                ...
                <div className="shared-score bg-white/10 backdrop-blur-sm rounded-3xl p-10 mb-8 border border-white/10">
                    ...
                    <div className="flex justify-center items-baseline gap-2 mb-4">
                        ...
                        <span className="text-3xl text-white/40">/ 17</span>
                    </div>
                    ...
                    <div className={`inline-flex items-center gap-2 px-6 py-3 rounded-full text-lg font-bold ${levelInfo.color === 'red' ? 'bg-red-500/20 text-red-300' :
                        levelInfo.color === 'orange' ? 'bg-orange-500/20 text-orange-300' :
                ...
                <div className="shared-content space-y-6">
                    ...
                    <p className="text-white/70 text-lg max-w-lg mx-auto">
                        Faites votre propre diagnostic pour comparer votre niveau de maturité comptable
