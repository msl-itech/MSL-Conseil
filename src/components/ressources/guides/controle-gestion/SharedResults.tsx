...
const LEVELS_INFO: Record<string, { color: string; emoji: string; description: string }> = {
    "Débutant": { color: "red", emoji: "🔴", description: "Vous n'avez pas encore mis en place de contrôle de gestion." },
    "Basique": { color: "orange", emoji: "🟠", description: "Quelques éléments suivis, mais de façon informelle." },
    "Intermédiaire": { color: "yellow", emoji: "🟡", description: "Des éléments en place, mais à mieux structurer." },
    "Structuré": { color: "green", emoji: "🟢", description: "Bonne avancée dans la démarche de gestion." },
    "Avancé": { color: "blue", emoji: "🔵", description: "Pilotage méthodique avec vision stratégique." },
};
            ...
            <div className="relative z-10 max-w-2xl mx-auto text-center">
                ...
                <div className="shared-score bg-white/10 backdrop-blur-sm rounded-3xl p-10 mb-8 border border-white/10">
                    ...
                    <div className="flex justify-center items-baseline gap-2 mb-4">
                        ...
                        <span className="text-3xl text-white/40">/ 50</span>
                    </div>
                ...
                <div className="shared-content space-y-6">
                    <h2 className="text-3xl md:text-4xl font-serif text-white">
                        Et vous, <span className="text-secondary">quel est votre profil</span> ?
                    </h2>

                    <p className="text-white/70 text-lg max-w-lg mx-auto">
                        Faites votre propre diagnostic pour découvrir votre niveau de maturité
