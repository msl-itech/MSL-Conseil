...
const LEVELS_INFO: Record<string, { color: string; emoji: string; description: string }> = {
    "Niveau Débutant": { color: "red", emoji: "🔴", description: "Structuration nécessaire. Posez les bases de l'automatisation." },
    "Niveau Intermédiaire": { color: "yellow", emoji: "🟡", description: "Bonne base à consolider. Renforcez votre analytique." },
    "Niveau Avancé": { color: "green", emoji: "🟢", description: "Architecture comptable performante. Continuez à optimiser." },
};

export default function SharedResults({ score, level, fromName, onStartDiagnostic, onReadGuide }: SharedResultsProps) {
    const containerRef = useRef<HTMLElement>(null);
    const levelInfo = LEVELS_INFO[level] || LEVELS_INFO["Niveau Intermédiaire"];
    ...
    return (
        <section
            ...
            style={{
                background: `linear-gradient(135deg, ${ODOO_PURPLE} 0%, #8e6180 100%)`
            }}
        >
            ...
            <div className="relative z-10 max-w-2xl mx-auto text-center">
                ...
                <div className="shared-score bg-white/10 backdrop-blur-sm rounded-3xl p-10 mb-8 border border-white/10">
                    ...
                    <div className="flex justify-center items-baseline gap-2 mb-4">
                        ...
                        <span className="text-3xl text-white/40">/ 31</span>
                    </div>
                ...
                <div className="shared-content space-y-6">
                    <h2 className="text-3xl md:text-4xl font-serif text-white">
                        Et vous, <span className="text-secondary">où en êtes-vous</span> ?
                    </h2>

                    <p className="text-white/70 text-lg max-w-lg mx-auto">
                        Faites votre propre diagnostic pour comparer votre niveau d&apos;automatisation
                        et de pilotage financier.
                    </p>
                    ...
                    <p className="text-white/40 text-sm mt-8 italic">
                        &quot;Le pilotage avancé commence par une architecture comptable solide.&quot;
                    </p>
                </div>
            </div>
        </section>
