...
export default function ContactContent() {
  ...
  return (
    <section
      ref={container}
      className="w-full py-24 px-6 md:px-12 bg-white relative"
    >
          ...
          <div className="bg-gray-50 rounded-[2rem] p-8 md:p-12 shadow-sm border border-gray-100 relative overflow-hidden">
            ...
            {status === "success" && (
              <div className="mb-6 p-4 rounded-xl bg-green-100 border border-green-200 text-green-800 text-sm font-medium flex items-center gap-2">
                <span>✅</span> Votre demande a été envoyée avec succès ! Nous
                vous recontacterons sous 24h.
              </div>
            )}
            {status === "error" && (
              <div className="mb-6 p-4 rounded-xl bg-red-50 border border-red-100 text-red-600 text-sm font-medium flex items-center gap-2">
                <span>⚠️</span> Une erreur est survenue. Veuillez réessayer ou
            ...
            <form onSubmit={handleSubmit} className="space-y-6">
              <div className="space-y-2">
                <label className="text-xs uppercase font-bold tracking-widest text-gray-500 ml-1">
                  Nom Complet
                </label>
                <input
                  type="text"
              ...
              <p className="text-center text-xs text-gray-400">
                Réponse rapide et personnalisée sous 24h.
              </p>
            </form>
          </div>
        </div>
        ...
        <div className="flex flex-col gap-12">
          ...
          <div className="contact-block space-y-8">
            ...
            <div className="grid gap-4">
              <a
                href="https://wa.me/+32486971329"
                target="_blank"
                rel="noopener noreferrer"
                className="flex items-center gap-6 p-6 bg-white border border-gray-100 rounded-2xl shadow-sm hover:shadow-md hover:border-green-500/30 transition-all group"
              >
                ...
                <div>
                  ...
                  <p className="text-sm text-gray-500">
                    Discussion instantanée avec un consultant
                  </p>
                </div>
              </a>
            ...
            <div className="relative z-20">
              ...
              <ul className="space-y-3 mb-8">
                <li className="flex items-center gap-3 text-sm font-medium">
                  <span className="text-secondary">✔</span> Un diagnostic de vos
                  flux financiers
                </li>
                <li className="flex items-center gap-3 text-sm font-medium">
                  <span className="text-secondary">✔</span> Une consultation
                  gratuite
                </li>
                <li className="flex items-center gap-3 text-sm font-medium">
                  <span className="text-secondary">✔</span> Un audit de vos
                  systèmes
                </li>
              </ul>
              ...
              <a
                ...
                target="_blank"
                rel="noopener noreferrer"
                className="block w-full bg-white text-primary font-bold py-4 rounded-xl hover:bg-secondary hover:text-white transition-all duration-300 text-center"
              >
                Voir les disponibilités
              </a>
              <p className="text-center text-[10px] text-white/40 mt-3 uppercase tracking-wider">
                Confirmation immédiate + rappel auto
              </p>
            </div>
          </div>
        </div>
                ...
                <div className="w-full bg-primary rounded-[2.5rem] py-16 px-6 md:px-12 text-center relative overflow-hidden shadow-2xl">
                    ...
                    <div className="relative z-10 max-w-3xl mx-auto">
                        ...
                        <div className="flex flex-col sm:flex-row justify-center gap-6">
                            <a href="https://odoo.mslconseils.be/appointment/15" target="_blank" rel="noopener noreferrer" className="px-8 py-4 bg-white text-primary rounded-full font-bold uppercase tracking-wider text-xs hover:bg-secondary hover:text-white transition-all duration-300 shadow-xl hover:scale-105 inline-block">
