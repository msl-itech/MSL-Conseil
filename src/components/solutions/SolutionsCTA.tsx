      ...
      <div className="cta-content max-w-5xl mx-auto bg-primary rounded-[3rem] p-12 md:p-20 text-center relative overflow-hidden shadow-2xl">
        ...
        <div className="relative z-10">
          ...
          <p className="text-white/70 text-lg mb-12 max-w-xl mx-auto">
            Discutons de vos besoins et voyons comment MSL peut vous aider à
            atteindre la clarté financière.
          </p>
          ...
          <div className="flex flex-col sm:flex-row gap-6 justify-center">
            <a
              ...
              className="px-10 py-5 bg-white text-primary rounded-full font-bold uppercase tracking-wider text-xs hover:bg-secondary transition-colors duration-300 shadow-xl hover:scale-105 inline-block"
            >
