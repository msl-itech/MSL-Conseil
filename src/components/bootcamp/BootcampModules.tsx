    ...
    variants: [
      {
        ...
        duration: "1 jour (8h)",
        detail: "½ journée immersion + ½ journée analyse",
      },
      { label: "Entreprise moyenne", duration: "2 jours (16h)", detail: null },
      { label: "Organisation complexe", duration: "Sur mesure", detail: null },
    ],
    highlight:
      "Cette phase est indissociable du bootcamp. Sans elle, il n'y a pas de formation pertinente.",
    color: "primary",
  },
  {
    id: 2,
    ...
    subtitle: "Déployer",
    description:
      "Sur base du rapport d'analyse, nous construisons votre parcours sur mesure",
    features: [
    ...
    >
          ...
          <div className="flex flex-col lg:flex-row lg:items-end lg:justify-between gap-12">
            <div className="lg:max-w-3xl">
              ...
              <h2 className="hero-title text-5xl md:text-7xl lg:text-8xl font-serif text-primary leading-[0.9] tracking-tight overflow-hidden">
                ...
                <br />
                <span className="inline-block italic text-secondary">
                  nos
                </span>{" "}
                <span className="inline-block italic text-secondary">
                  bootcamps
            ...
            <div className="float-card relative bg-white rounded-3xl p-8 shadow-2xl shadow-primary/10 border border-gray-100 lg:min-w-[280px]">
              ...
              <div className="relative">
                ...
                <p className="text-6xl font-serif text-primary">
                  10<span className="text-2xl text-secondary ml-1">jours</span>
                </p>
            ...
            {PHASES.map((phase) => (
              ...
              >
                ...
                <div className="p-8">
                  ...
                  {phase.variants && (
                    <div className="grid grid-cols-1 gap-4 mb-8">
                      {phase.variants.map((variant, i) => (
                        <div
                          key={i}
                          className="group/item flex items-center gap-4 p-4 bg-gray-50 rounded-2xl hover:bg-primary/5 transition-colors cursor-default"
                        >
                  ...
                  >
                    <p
                      className={`font-medium ${phase.color === "primary" ? "text-primary" : "text-primary"}`}
                    >
                      👉 {phase.highlight}
                    </p>
                  </div>
      ...
      <div className="pricing-section relative py-32 px-6 md:px-12 lg:px-24 bg-primary overflow-hidden">
        ...
        <div className="absolute inset-0 overflow-hidden">
          ...
          <div
            className="absolute bottom-40 right-32 w-3 h-3 bg-secondary/30 rounded-full animate-ping"
        ...
        <div className="max-w-6xl mx-auto relative z-10">
          <div className="text-center mb-16">
            ...
            <h3 className="text-4xl md:text-6xl font-serif text-white mb-4">
              Logique de{" "}
              <span className="text-secondary italic">tarification</span>
            </h3>
            <p className="text-xl text-white/60 max-w-2xl mx-auto">
              Nous ne vendons pas des packs. Nous facturons du temps
              d'intervention à forte valeur ajoutée.
            </p>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8 mb-16">
            ...
            <div className="relative bg-white/10 backdrop-blur-xl rounded-3xl p-10 border border-white/20 overflow-hidden group hover:bg-white/15 transition-colors">
              ...
              <div className="relative">
                ...
                <div className="flex items-baseline gap-2 mb-4">
                  <span className="pricing-number text-7xl md:text-8xl font-serif text-secondary">
                    150
                  </span>
            ...
            <div className="relative bg-white/5 backdrop-blur-xl rounded-3xl p-10 border border-white/10 overflow-hidden">
              ...
              <p className="text-white/60">
                du temps de trajet facturé
                <br />
                (coût matériel et temps non productif)
              </p>
            </div>
          </div>
          ...
          <div className="flex flex-wrap justify-center gap-4">
            {["Transparence", "Équité", "Alignement effort/valeur"].map(
              (item, i) => (
                <span
                  key={i}
                  className="px-6 py-3 bg-secondary/20 text-secondary rounded-full font-medium backdrop-blur-sm border border-secondary/30"
                >
                  {item}
                </span>
              ),
          ...
          <p className="text-center text-2xl md:text-3xl font-serif text-white/80 italic mt-16 max-w-3xl mx-auto">
            "Vous ne payez pas un nombre de jours. Vous investissez dans de la{" "}
            <span className="text-secondary">clarté</span>, de l'
            <span className="text-secondary">autonomie</span> et de la{" "}
            <span className="text-secondary">maîtrise</span>."
          </p>

          {/* Ordres de grandeur */}
          <div className="mt-16 bg-white/10 backdrop-blur-xl rounded-3xl p-10 border border-white/20">
            <h4 className="text-2xl font-serif text-white mb-6 text-center">
              Ordres de grandeur{" "}
              <span className="text-white/50 text-lg">
                (repères, pas promesses)
              </span>
            </h4>
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              <div className="bg-white/5 rounded-2xl p-6 border border-white/10">
                ...
                <p className="text-3xl font-serif text-secondary">
                  1 à 2 <span className="text-lg text-white/70">jours</span>
                </p>
              </div>
              <div className="bg-white/5 rounded-2xl p-6 border border-white/10">
                <p className="text-white/50 uppercase tracking-widest text-xs mb-2">
                ...
                <p className="text-3xl font-serif text-secondary">
                  2 à 10{" "}
                  <span className="text-lg text-white/70">jours max</span>
                </p>
                <p className="text-white/50 text-sm mt-2">
                  selon périmètre, maturité, nb participants
                </p>
              </div>
            </div>
            <p className="text-center text-white/70 mt-6">
              👉 Le périmètre exact est défini après l'analyse, jamais avant.
            </p>
          </div>
        </div>
      </div>
        ...
        <div className="max-w-6xl mx-auto">
          <div className="text-center mb-16">
            <h3 className="text-4xl md:text-6xl font-serif text-primary mb-4">
              Impact & <span className="text-secondary italic">ROI</span>{" "}
              observés
            </h3>
          </div>
          ...
          <div className="impacts-grid grid grid-cols-2 md:grid-cols-3 lg:grid-cols-6 gap-4 mb-16">
            {IMPACTS.map((impact, i) => (
              <div
                key={i}
                className="impact-item group relative bg-white rounded-2xl p-6 text-center shadow-lg hover:shadow-2xl hover:-translate-y-2 transition-all duration-500 border border-gray-100 hover:border-secondary/30 cursor-default"
              >
              ...
              <div className="grid grid-cols-1 md:grid-cols-3 gap-10">
                <div className="text-center md:text-left">
                  <div className="flex items-center justify-center md:justify-start gap-3 mb-2">
                    <span className="text-4xl md:text-5xl font-serif text-gray-400">
                      4%
                    </span>
                    <svg
                    ...
                    <span
                      className="text-4xl md:text-5xl font-serif text-primary counter-value"
                      data-target="8"
                    >
                      0
                    </span>
                ...
                <div className="text-center">
                  <p className="text-5xl md:text-6xl font-serif text-secondary mb-2">
                    +
                    <span className="counter-value" data-target="78">
                      0
                    </span>{" "}
                    000 €
                  </p>
          ...
          <div className="flex flex-col lg:flex-row lg:items-center gap-12">
            <div className="lg:w-1/3">
              <h3 className="text-3xl md:text-4xl font-serif text-primary">
                ...
                <span className="text-secondary italic">nos bootcamps ?</span>
              </h3>
            </div>
            <div className="lg:w-2/3 grid grid-cols-2 md:grid-cols-4 gap-4">
              {TARGETS.map((target, i) => (
                <div
                  key={i}
                  className="group bg-white rounded-2xl p-6 text-center hover:bg-primary hover:text-white transition-all duration-300 shadow-sm hover:shadow-xl cursor-default"
                >
        ...
        <div className="max-w-4xl mx-auto relative z-10 text-center">
          ...
          <h3 className="text-4xl md:text-6xl lg:text-7xl font-serif text-white mb-6 leading-tight">
            ...
            <span className="text-secondary italic">
              Nous devenons inutiles.
            </span>
          </h3>

          <p className="text-xl text-white/60 mb-12 max-w-2xl mx-auto">
            Vous repartez avec des équipes formées, des processus maîtrisés et
            une logique de pilotage totalement autonome.
          </p>
          ...
          <div className="flex flex-col sm:flex-row flex-wrap gap-4 justify-center">
            ...
            <Link
              href="https://odoo.mslconseils.be/appointment/15"
              target="_blank"
